...
class TestCheckRegexs(unittest.TestCase):
    ...
    def _call_check_quality(self, req):
        ...
        json_payload['config'] = { 'algorithms': ['RegularExpressions'] }
    ...
    def test_algorithm_reached_and_found(self):
        response = self._call_check_quality('The system must support PDFs and Doc or Docx.')
